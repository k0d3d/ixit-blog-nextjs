  ...
  return (
    <div className="single-blog-full-content">
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-8 m-auto">
            <div className="post-full-content">
              <p className="title-content">tHe that after the in makes cleaning forget all intention at here, through had company here's its too at leaders, the a end or thousands the it explain floundering and on also that for after small is compared from with he sharpness origin; Is she was indeed, each if leastgoals </p>
        ...
        <div className="row">
          <div className="col-lg-8 m-auto pt-50 pb-100 pb-md-50">
